...
{
    sglFigure my_fig;               // create OpenGL figure instance with desired properties
    ...
    auto my_line = my_fig.addObject( sglLine (0.0,0.0,0.0, 1.0,1.0,1.0) );  // (x0,y0,z0, x1,y1,z1)
    // etc...
...
- For compiling your code, you'll need to link to the GL, glut, X11 and pthread libraries.
